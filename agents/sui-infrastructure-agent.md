---
name: sui-infrastructure-agent
description: Provide documentation queries and security scanning services to all other agents. Delegates to sui-docs-query-subagent for documentation and sui-security-guard-subagent for security scans.
tools: Task, Skill, Read, Grep, Bash
model: sonnet
---
