---
name: sui-ecosystem-agent
description: Integrate with SUI ecosystem services (Kiosk, Walrus, zkLogin, DeepBook, etc.). Provides integration patterns and code by delegating to specialized ecosystem subagents.
